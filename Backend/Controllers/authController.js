...
exports.signUp = asyncErrorHandler(async (req, res, next) => {
  try {
    ...
    console.log("Uploaded File Info:", req.file); // Debugging: log file details

    // Check if file was uploaded and attach file path to the user data
    if (req.file) {
      req.body.picture = req.file.path; // Store the uploaded image path in the user data
      console.log("Picture Path Saved:", req.body.picture); // Debugging: confirm path
    }

    // Create the user in the database
    // const newUser = await User.create(req.body);

    // Send token response with the user data
